...
def get_filters():
    ...
    while True:
        city = input("Enter the name of the city you'd like to analyze (chicago, new york city, washington): ")
        city = city.lower()
    ...
    while True:
        month = input("Enter the name of the month you'd like to filter by (all, january, february, ... , june): ")
        month = month.lower()
    ...
    while True:
        day = input("Enter the name of the day of the week you'd like to filter by (all, monday, tuesday, ... sunday): ")
        day = day.lower()
...
def station_stats(df):
    ...
    print("The most frequent combination of start station and end station trip is: ", most_common_start_end_combination)
    
    # prompt user to display raw data
